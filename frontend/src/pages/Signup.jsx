      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="md:mx-7 py-7 lg:pl-6  rounded-lg shadow-lg  border border-solid border-fuchsia-50">
              ...
              <div className="mb-3 flex items-center jujstify-between">
                ...
                >
                  ...
                  >
                    ...
                    <option value="doctor"> Theripist</option>
                  </select>
                </label>
                <label
                  htmlFor=""
            ...
            >
                  {loading ? <HashLoader color='white' size={35} className="text-center m-auto"/>:'Sign Up'}
            </button>
          </div>
          <p className="mt-3 mb-4 text-textColor text-center text-[15px]">
            Already have an account?<Link to='/login' className="text-irisBlueColor"> Log in</Link>
          </p>
